...
Shogun armor, Roman and Greek military forms, medieval standards and northern longship silhouettes meet an original cosmic setting. The editable Blender kit contains the pilot, fighters, alien, flagship, corridor and rift core. The opening is an original twenty-four-second ink-and-starlight sequence, followed by an animated astral loading scene that waits for the player to enter command. An original dark ceremonial title theme combines plucked strings, bowed voices, breathy flute, gongs and drums. The title screen attempts to start its own theme automatically on entry, respecting saved mute and volume. Browsers that block audible autoplay retain the click, tap or keypress fallback without advancing. Starting the opening fades into a separate, gently voiced intro arrangement. The later scores use warm sustained harmonies, soft plucked accents and measured percussion, with smooth note envelopes and zone fades. That intro music continues through loading, command menu, lobby and initial orbital flight without restarting; later zones change arrangement at a phrase boundary, with one musical score active at a time. Spatial action cues and continuous flight audio share the same volume controls.
