import {GLTFLoader} from './vendor/GLTFLoader.js?v=8';
...
function download(){
 if(!pendingDownload)pendingDownload=(async()=>{
  ...
  try{
   const response=await fetch(new URL('./assets/novaris-vanguard.glb?v=8',import.meta.url),{signal:controller.signal});
